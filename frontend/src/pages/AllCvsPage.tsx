...
const mockReviews: CVReview[] = [
  {
    ...
    ragSummary:
      'Strong experience in Python, machine learning, and AI development.',
    strengths: ['Python', 'Machine Learning'],
    matchingRequirements: ['Python', 'AI Development'],
    missingRequirements: [],
  ...
  },
  {
    ...
    ragSummary:
      'Matches several technical requirements but requires human verification.',
    strengths: ['SQL', 'Data Pipelines'],
    matchingRequirements: ['SQL', 'Python'],
    missingRequirements: ['Cloud certification'],
    createdAt: '2026-09-21',
  },
  {
    id: '3',
    ...
    ragSummary:
      'General IT experience but missing key DevOps requirements.',
    strengths: ['Linux'],
    matchingRequirements: ['Linux'],
    missingRequirements: ['Docker', 'Kubernetes', 'CI/CD'],
    rejectionReason:
      'Required DevOps experience was not demonstrated.',
    createdAt: '2026-09-21',
  },
  {
    id: '4',
    ...
    matchingRequirements: ['Python', 'SQL', 'Data Pipelines'],
    missingRequirements: [],
  ...
  },
  {
    ...
    jobRequirement: 'AI Engineer',
    ragSummary:
      'Good AI background, but some experience details require verification.',
    strengths: ['Python', 'AI'],
    matchingRequirements: ['Python', 'Machine Learning'],
    missingRequirements: ['Experience verification'],
    createdAt: '2026-09-20',
  },
  {
    id: '6',
    ...
    strengths: ['Basic SQL'],
    matchingRequirements: ['SQL'],
    missingRequirements: ['Python', 'Data Pipelines'],
    rejectionReason:
...
function AllCvsPage() {
  ...
  const jobs = useMemo(
    () => [...new Set(mockReviews.map((review) => review.jobRequirement))],
    [],
  )

  const filteredReviews = useMemo(() => {
    const result = mockReviews.filter((review) => {

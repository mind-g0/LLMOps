...
function AppLayout() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-slate-50 transition-colors duration-300 dark:bg-slate-950">
        ...
        <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-4 py-3 sm:px-6">
          ...
          <div className="flex items-center gap-2 md:hidden">
            ...
            <button
              type="button"
              onClick={toggleLanguage}
              className="flex h-10 items-center gap-1.5 rounded-lg border border-slate-200 bg-white px-2.5 text-sm font-semibold text-slate-700 transition hover:bg-slate-100 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700"
              aria-label={
                isArabic
                  ? 'Switch to English'
                  : 'التبديل إلى العربية'
            ...
            <button
              ...
              className="flex h-10 w-10 items-center justify-center rounded-lg border border-slate-200 text-slate-700 transition hover:bg-slate-100 dark:border-slate-700 dark:text-slate-200 dark:hover:bg-slate-800"
      ...
      {/* Main Content */}
      <main className="mx-auto w-full max-w-7xl flex-1 px-4 py-6 text-slate-900 transition-colors dark:text-slate-100 sm:px-6">
        <Outlet />
      </main>

      {/* Footer */}
      <footer className="mt-16 border-t border-slate-200 bg-white transition-colors dark:border-slate-800 dark:bg-slate-900">
        ...
        <div className="mx-auto w-full max-w-7xl px-4 py-6 sm:px-6">
          ...
          <div className="flex flex-col items-center justify-between gap-3 text-center md:flex-row">
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400">
              © {new Date().getFullYear()} WeCloudData. {t('footer.rights')}
            </p>
